...
class Pipeline:
    ...
    def start_data_transformations(self):
        data_transformaton = Data_Transformation(data_ingestion_artifact= self.data_ingestion_artifact)
        self.data_transformtion_config = data_transformaton.initiate_data_transformation()
        return self.data_transformtion_config
